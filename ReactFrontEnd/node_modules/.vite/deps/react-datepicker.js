  ...
  function YearDropdownOptions2(props) {
    ...
    _defineProperty(_this, "renderOptions", function() {
      ...
      var options = _this.state.yearsList.map(function(year) {
        ...
        }, selectedYear === year ? import_react2.default.createElement("span", {
      ...
      if (!maxYear || !_this.state.yearsList.find(function(year) {
        ...
        options.unshift(import_react2.default.createElement("div", {
      ...
      if (!minYear || !_this.state.yearsList.find(function(year) {
        ...
        options.push(import_react2.default.createElement("div", {
          className: "react-datepicker__year-option",
          key: "previous",
  ...
  function YearDropdown2() {
    ...
    _defineProperty(_this, "renderSelectOptions", function() {
      ...
      for (var i = minYear; i <= maxYear; i++) {
        options.push(import_react2.default.createElement("option", {
          key: i,
          value: i
        }, i));
      }
    ...
    _defineProperty(_this, "renderDropdown", function() {
      return import_react2.default.createElement(WrappedYearDropdownOptions, {
        key: "dropdown",
  ...
  function MonthDropdownOptions2() {
    ...
    _defineProperty(_this, "renderOptions", function() {
      return _this.props.monthNames.map(function(month, i) {
        ...
        }, _this.isSelectedMonth(i) ? import_react2.default.createElement("span", {
  ...
  function MonthDropdown2() {
    ...
    _defineProperty(_this, "renderSelectOptions", function(monthNames) {
      return monthNames.map(function(M, i) {
        return import_react2.default.createElement("option", {
          key: i,
          value: i
        }, M);
      });
    ...
    _defineProperty(_this, "renderDropdown", function(monthNames) {
      return import_react2.default.createElement(WrappedMonthDropdownOptions, {
        key: "dropdown",
  ...
  function MonthYearDropdownOptions2(props) {
    ...
    _defineProperty(_this, "renderOptions", function() {
      return _this.state.monthYearsList.map(function(monthYear) {
        ...
        }, isSameMonthYear ? import_react2.default.createElement("span", {
...
var MonthYearDropdown = function(_React$Component) {
  function MonthYearDropdown2() {
    ...
    _defineProperty(_this, "renderDropdown", function() {
      return import_react2.default.createElement(WrappedMonthYearDropdownOptions, {
        key: "dropdown",
...
var Day = function(_React$Component) {
  function Day2() {
    ...
    _defineProperty(_this, "dayEl", import_react2.default.createRef());
    ...
    _defineProperty(_this, "render", function() {
      ...
      }, _this.renderDayContents(), _this.getTitle() !== "" && import_react2.default.createElement("span", {
        className: "overlay"
      }, _this.getTitle()));
    });
    return _this;
...
var WeekNumber = function(_React$Component) {
  function WeekNumber2() {
    ...
    _defineProperty(_this, "weekNumberEl", import_react2.default.createRef());
    _defineProperty(_this, "handleClick", function(event) {
  ...
  function Week2() {
    ...
    _defineProperty(_this, "renderDays", function() {
      ...
      if (_this.props.showWeekNumber) {
        ...
        days.push(import_react2.default.createElement(WeekNumber, {
          key: "W",
          weekNumber,
          date: startOfWeek2,
      ...
      return days.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset2) {
        ...
        return import_react2.default.createElement(Day, {
...
var Month = function(_React$Component) {
  function Month2() {
    ...
    _defineProperty(_this, "renderWeeks", function() {
      ...
      while (true) {
        weeks.push(import_react2.default.createElement(Week, {
...
var Time = function(_React$Component) {
  ...
  return _createClass(Time2, [{
    ...
    value: function render() {
      ...
      }, this.props.timeCaption)), import_react2.default.createElement("div", {
  ...
  return _createClass(Year2, [{
    ...
    value: function render() {
      ...
      var _loop = function _loop2(y2) {
        yearsList.push(import_react2.default.createElement("div", {
...
var inputTime = function(_React$Component) {
  function inputTime2(props) {
    ...
    _defineProperty(_this, "renderTimeInput", function() {
      ...
      if (customTimeInput) {
        return import_react2.default.cloneElement(customTimeInput, {
          date,
          value: time,
  ...
  return _createClass(inputTime2, [{
    ...
    value: function render() {
      ...
      }, this.props.timeInputLabel), import_react2.default.createElement("div", {
...
var Calendar = function(_React$Component) {
  function Calendar2(props) {
    ...
    _defineProperty(_this, "header", function() {
      ...
      if (_this.props.showWeekNumbers) {
        dayNames.push(import_react2.default.createElement("div", {
          key: "W",
    ...
    _defineProperty(_this, "renderYearDropdown", function() {
      ...
      return import_react2.default.createElement(YearDropdown, {
    ...
    _defineProperty(_this, "renderMonthDropdown", function() {
      ...
      return import_react2.default.createElement(MonthDropdown, {
        dropdownMode: _this.props.dropdownMode,
        locale: _this.props.locale,
    ...
    _defineProperty(_this, "renderMonthYearDropdown", function() {
      ...
      return import_react2.default.createElement(MonthYearDropdown, {
        dropdownMode: _this.props.dropdownMode,
        locale: _this.props.locale,
        dateFormat: _this.props.dateFormat,
    ...
    _defineProperty(_this, "renderDefaultHeader", function(_ref8) {
      ...
      }, _this.renderCurrentMonth(monthDate), import_react2.default.createElement("div", {
        className: "react-datepicker__header__dropdown react-datepicker__header__dropdown--".concat(_this.props.dropdownMode),
        onFocus: _this.handleDropdownFocus
      }, _this.renderMonthDropdown(i !== 0), _this.renderMonthYearDropdown(i !== 0), _this.renderYearDropdown(i !== 0)), import_react2.default.createElement("div", {
    ...
    _defineProperty(_this, "renderCustomHeader", function() {
      ...
      })), showDayNames && import_react2.default.createElement("div", {
        className: "react-datepicker__day-names"
      }, _this.header(monthDate)));
    });
    ...
    _defineProperty(_this, "renderMonths", function() {
      ...
      for (var i = 0; i < _this.props.monthsShown; ++i) {
        ...
        monthList.push(import_react2.default.createElement("div", {
          key: monthKey,
    ...
    _defineProperty(_this, "renderYears", function() {
      ...
      if (_this.props.showYearPicker) {
        ...
        }), import_react2.default.createElement(Year, _extends({
          onDayClick: _this.handleDayClick,
          selectingDate: _this.state.selectingDate,
    ...
    _defineProperty(_this, "renderTimeSection", function() {
      if (_this.props.showTimeSelect && (_this.state.monthContainer || _this.props.showTimeSelectOnly)) {
        return import_react2.default.createElement(Time, {
          selected: _this.props.selected,
    ...
    _defineProperty(_this, "renderInputTimeSection", function() {
      ...
      if (_this.props.showTimeInput) {
        return import_react2.default.createElement(inputTime, {
          date: time,
          timeString,
    ...
    _this.containerRef = import_react2.default.createRef();
    _this.state = {
  ...
  return _createClass(Calendar2, [{
    ...
    value: function render() {
      ...
      }, import_react2.default.createElement(Container, {
...
var TabLoop = function(_React$Component) {
  function TabLoop2(props) {
    ...
    _this.tabLoopRef = import_react2.default.createRef();
    return _this;
  }
  ...
  return _createClass(TabLoop2, [{
    ...
    value: function render() {
      ...
      }), this.props.children, import_react2.default.createElement("div", {
...
function withFloating(Component2) {
  var WithFloating = function WithFloating2(props) {
    ...
    var arrowRef = import_react2.default.useRef();
    ...
    return import_react2.default.createElement(Component2, _extends({}, alt_props, {
  ...
  return _createClass(PopperComponent2, [{
    ...
    value: function render() {
      ...
      if (!hidePopper) {
        ...
        popper = import_react2.default.createElement(TabLoop, {
          enableTabLoop
        }, import_react2.default.createElement("div", {
        ...
        }, popperComponent, showArrow && import_react2.default.createElement(FloatingArrow, {
      ...
      if (this.props.popperContainer) {
        popper = import_react2.default.createElement(this.props.popperContainer, {}, popper);
      }
      if (portalId && !hidePopper) {
        popper = import_react2.default.createElement(Portal, {
          portalId,
          portalHost
        }, popper);
      }
...
var DatePicker = function(_React$Component) {
  function DatePicker2(props) {
    ...
    _defineProperty(_this, "renderCalendar", function() {
      ...
      return import_react2.default.createElement(WrappedCalendar, {
    ...
    _defineProperty(_this, "renderDateInput", function() {
      ...
      var customInput = _this.props.customInput || import_react2.default.createElement("input", {
        type: "text"
      });
      ...
      return import_react2.default.cloneElement(customInput, (_React$cloneElement = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_React$cloneElement, customInputRef, function(input) {
        _this.input = input;
  ...
  return _createClass(DatePicker2, [{
    ...
    value: function renderInputContainer() {
      ...
      }, showIcon && import_react2.default.createElement(CalendarIcon$1, _extends({
        icon,
    ...
    value: function render() {
      ...
      if (this.props.withPortal) {
        var portalContainer = this.state.open ? import_react2.default.createElement(TabLoop, {
        ...
        if (this.state.open && this.props.portalId) {
          portalContainer = import_react2.default.createElement(Portal, {
            portalId: this.props.portalId,
            portalHost: this.props.portalHost
          }, portalContainer);
        }
        return import_react2.default.createElement("div", null, this.renderInputContainer(), portalContainer);
      }
      return import_react2.default.createElement(PopperComponent$1, {

import {
  ...
  useRole,
  useTypeahead
} from "./chunk-CHLCU2FN.js";
import {
  require_jsx_runtime
} from "./chunk-L7NFZ2O2.js";
import "./chunk-3V7233WM.js";
import {
  require_react
} from "./chunk-T5MYUEW3.js";
import {
  __commonJS,
  __publicField,
  __toESM
...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react8.forwardRef)(({ children, className, color = "info", disabled, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner, gradientDuoTone, gradientMonochrome, label, outline = false, pill = false, positionInGroup = "none", size = "md", theme: customTheme = {}, ...props }, ref) => {
...
var DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [(0, import_jsx_runtime25.jsx)("div", { className: theme2.header.base, children: weekDays.map((day, index) => (0, import_jsx_runtime25.jsx)("span", { className: theme2.header.title, children: day }, index)) }), (0, import_jsx_runtime25.jsx)("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index) => {
...
var Trigger = ({ refs, children, inline, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline ? (0, import_jsx_runtime33.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime33.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const handleSelect = (0, import_react25.useCallback)((index) => {
    setSelectedIndex(index);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react25.useCallback)((index) => {
    if (open) {
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react31.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size], theme2[filled ? "filled" : "empty"], className), ...props });
};

// node_modules/flowbite-react/lib/esm/components/Rating/Rating.js
var RatingComponent = ({ children, className, size = "sm", theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(getTheme().rating, customTheme);
  return (0, import_jsx_runtime68.jsx)(RatingContext.Provider, { value: { theme: theme2, size }, children: (0, import_jsx_runtime68.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var TabsComponent = (0, import_react55.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime86.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime86.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index) => (0, import_jsx_runtime86.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index}`, "aria-selected": index === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index === activeTab && tabItemStyle.active.on, index !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index}`, onClick: () => handleClick({ target: index }), onKeyDown: (event) => handleKeyboard({ event, target: index }), ref: (element) => tabRefs.current[index] = element, role: "tab", tabIndex: index === focusedTab ? 0 : -1, style: { zIndex: index === focusedTab ? 2 : 1 }, children: [tab.icon && (0, import_jsx_runtime86.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index)) }), (0, import_jsx_runtime86.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index) => (0, import_jsx_runtime86.jsx)("div", { "aria-labelledby": `${id}-tab-${index}`, className: theme2.tabpanel, hidden: index !== activeTab, id: `${id}-tabpanel-${index}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index)) })] });
});
